...
var resizePizzas = function(size) {
  ...
  // Modified document.querySelector to document.getElementById to improve performance
  ...
  // Modified querySelectorAll with getElementsByClassName to improve performance
  // Removed function determineDx which has similar code to calculate the newwidth of pizza
  var newWidth;
  function changePizzaSizes(size) {
    ...
    // For more efficiency saved array length in a local variable
    var lenPizzaContainer = ranPizzaContainer.length;
...
// Moved pizzasElm out of loop for optimization
// Modified 100 to 30 pizza images to reduce load time
var pizzasElm = document.getElementById("randomPizzas");
for (var i = 2; i < 30; i++) {
  pizzasElm.appendChild(pizzaElementGenerator(i));
}
...
// Modified "querySelectorAll" to "getElementsByClassName".
// Source https://discussions.udacity.com/t/project-4-how-do-i-optimize-the-background-pizzas-for-loop/36302
...
// To avoid the DOM from being called on each iteration var movingPizzas is declared outside the for loop
var movingPizzas = document.getElementById("movingPizzas1");
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  //To generate pizzas according to screen height
